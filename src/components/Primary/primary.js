    ...
    return(
        <div className="primary">
            ...
            <div className="primary-top">
                ...
                <iframe className="primary-video"  width="1000" height="560" src="https://www.youtube.com/embed/i76gPpka2Fo" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                ...
                <div className="grid">
                    ...
                    <div className="grid-container">
                        <div className="grid-item-1">
                            <img className="primary-img" src={spiderman}/>
                        ...
                        <div className="grid-item-2">
                            <img className="primary-img" src="https://s7test3.scene7.com/is/image/SIEPDC/ps5-horizon-forbidden-west-video-thumb-01-en-11jun20?$native$"/>
                    ...
                    <div className="grid-container">
                        <div className="grid-item-1">
                            <img className="primary-img" src="https://s7test3.scene7.com/is/image/SIEPDC/ps5-ratchet-and-clank-rift-apart-video-thumb-01-en-11jun20?$native$"/>
                        ...
                        <div className="grid-item-2">
                            <img className="primary-img" src="https://s7test3.scene7.com/is/image/SIEPDC/ps5-gt7-video-thumb-01-en-11jun20?$native$"/>
                    ...
                    <div className="grid-container">
                        <div className="grid-item-1">
                            <img className="primary-img" src="https://s7test3.scene7.com/is/image/SIEPDC/ps5-returnal-video-thumb-block-05-en-11jun20?$native$"/>
                        ...
                        <div className="grid-item-2">
                            <img className="primary-img" src="https://s7test3.scene7.com/is/image/SIEPDC/ps5-sackboy-video-thumb-block-06-en-11jun20?$native$"/>
